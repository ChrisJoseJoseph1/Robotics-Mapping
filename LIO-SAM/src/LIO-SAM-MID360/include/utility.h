...
// Put PCL before OpenCV for Noetic/PCL 1.10 compatibility
...
// Avoid macro conflict that can break FLANN/PCL on Noetic
...
// Keep current include style used by this branch/workspace
...
public:
    ...
    sensor_msgs::Imu imuConverter(const sensor_msgs::Imu &imu_in)
    {
        ...
        // livox built-in 6-axis imu acceleration unit is g, convert to m/s^2
        if (imuType == 0)
            acc *= imuGravity;
